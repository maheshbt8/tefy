...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2019 at 04:34 PM
...
INSERT INTO `listings` (`id`, `school_name`, `category`, `keywords`, `curriculum`, `class`, `landmark`, `latitude`, `longitude`, `address`, `video`, `vision`, `description`, `phone`, `website`, `email`, `facebook`, `twitter`, `google_plus`, `amenities`, `opening_hours`, `achievements`, `created_at`, `modified_at`, `row_status`) VALUES
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1568987645, 1, 'Admin', 'istrator', 'ADMIN', '0');
