...
<!-- School Code -->
						...
						<div class="row with-forms">
							...
							<div class="col-md-3">
                                <h5>Classes</h5>
                                <!-- <select class="chosen-select-no-single form-control selectric"  name="class[]" required="">
                            ...
                            <div class="col-md-3">
                                <h5>Price From</h5>
								<input type="number" placeholder="Enter Price From"  name="price_from" required="" value="<?=set_value('price_from');?>">
